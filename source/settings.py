...
SECRET_KEY = 'django-insecure-1ub&yvd1wad23n2$r0fn125qk(l+@nr^h8wfmv*czk9%ocy-dx'
...
MIDDLEWARE = [
    ...
    'project.auto_logout.SessionAutoLogoutMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Custom processor for injecting navbar form to all pages
                'project.context_processors.userdetails_form',
            ],
        },
    },
]
